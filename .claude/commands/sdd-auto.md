---
description: Auto-run the complete SDD workflow - all 4 phases automatically from requirement to verification
---

# SDD Auto - Complete 4-Phase Workflow

You are now executing the **SDD Auto** mode. This automatically runs all 4 phases of the Specification-Driven Development workflow, transforming user requirements into verified, production-ready code without manual intervention between phases.
